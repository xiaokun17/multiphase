...
def apply_bound_transform(bound, config):
    ...
    if 5 < config.time_count[None] and config.time_count[None] < 8.3:
    ...
    elif config.time_count[None]>8.5 and config.time_count[None]<15.5:
        ang = config.ang_spd[None] * config.dt[None]
